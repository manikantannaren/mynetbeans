...
@Messages({
    "LBL_NBCSVFileType_LOADER=Files of NBCSVFileType"
})
...
//        FileObject propFileFo = FileUtil.createData(propFile);
...
//        CSVSheet sheet = new CSVSheet(obj.getNameExt(), obj);
//        return new CSVSheetNode(sheet);
//    }
